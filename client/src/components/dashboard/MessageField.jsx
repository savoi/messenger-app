...
export default function MessageField({ setError, sendMessage, activeConversationId, activeConversationUsers }) {
  ...
  const handleSubmit = (event) => {
    ...
    if (message) {
      sendMessage(activeConversationId, message, activeConversationUsers);
      setMessage("");
    }
  }
